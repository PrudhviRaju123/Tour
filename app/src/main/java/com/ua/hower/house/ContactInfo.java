    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mail_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                        "mailto", "howerhouse@uakron.edu", null));
        ...
        phone_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                phone_intent.setData(Uri.parse("tel:3309726909"));
        ...
        google_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Google_intent.setData(Uri.parse("geo:Hower House at The University of Akron, Fir Hill, Akron, OH?q=Hower House at The University of Akron, Fir Hill, Akron, OH"));
