...
public class CircularSeekBar extends View {
	...
	private static final float DEFAULT_CIRCLE_STROKE_WIDTH = 9f;
	...
	private void initAttributes(TypedArray attrArray) {
		...
		mMax = attrArray.getInt(R.styleable.CircularSeekBar_circulr_max, DEFAULT_MAX);
		mProgress = attrArray.getInt(R.styleable.CircularSeekBar_circular_progress, DEFAULT_PROGRESS);
